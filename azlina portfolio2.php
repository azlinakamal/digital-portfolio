    ...
    <div class="page-header page-header-small" filter-color="green">
      ...
      <div class="container">
        <div class="content-center">
          <div class="cc-profile-image"><a href="<div class="cc-profile-image"><a href=><img src="C:\New folderstuido\Mosaic Effect Photot Editor\IMG_20211010_115823.jpg" alt="Image"/></a></div>"><img src="" alt="Image"/></a></div>
          <div class="h2 title">Azlina
</div>
        </div>
      </div>
    </div>
        ...
        <div class="col-lg-6 col-md-12">
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-sm-8">19
</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Email:</strong></div>
              <div class="col-sm-8">
azlina30@gmail.com</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Phone:</strong></div>
              <div class="col-sm-8">8776549876</div>
            </div>
            <div class="row mt-3">
              <div class="col-sm-4"><strong class="text-uppercase">Address:</strong></div>
              <div class="col-sm-8">1/140a,mullai nagar,andipalayam thiruvarur</div>
            </div>
            <div class="row mt-3">
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p>hi i m dhivya dharshini college student i m studing 3ed year.</p>
          </div>
        </div>
      </div>
    </div>  
...
<div class="section">
  <div class="container cc-education">
      ...
      <div class="row">
        ...
        <div class="col-md-9" data-aos="fade-left" data-aos-offset="50" data-aos-duration="500">
          <div class="card-body">
            ...
            <p>my hobby is singing and i know html  and i m a salesforce developer and i joined college in 2021 i m a college student union president.</p>
          </div>
        </div>
      </div>
    </div> 
    ...
    <footer class="footer">
      ...
      <div class="h4 title text-center">Dhivya dharshinni</div>
